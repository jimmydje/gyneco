...
function buildEmailHtml({
  ...
  const t = isFr
    ? {
        ...
        body: "Nous vous remercions de votre inscription aux <strong>Journées de Gynécologie & Obstétrique d'Annaba</strong>. Votre inscription a bien été reçue et confirmée.<br><br><strong>Prix d'inscription : 2000 DA — Paiement sur place le jour J.</strong>",
    ...
    : {
        ...
        body: "Thank you for registering for the <strong>Annaba Gynecology & Obstetrics Conference</strong>. Your registration has been successfully received and confirmed.<br><br><strong>Registration fee: 2000 DA — Payment on site on the day of the event.</strong>",
